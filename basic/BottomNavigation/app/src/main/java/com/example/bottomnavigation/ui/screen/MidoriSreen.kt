...
import com.example.bottomnavigation.ui.vm.MidoriViewModel
...
fun MidoriScreen(
    ...
    val viewModel : MidoriViewModel = viewModel()
    ...
    Column(
        ...
        if(buttonClicked.value){
            Image(painter = painterResource(id = R.drawable.iv_midori_momoi),
                contentDescription = "Midori",
                modifier = Modifier.size(250.dp,250.dp)
            )
        } else {
            Image(painter = painterResource(id = R.drawable.iv_midori),
                contentDescription = "Midori",
                modifier = Modifier.size(250.dp,250.dp)
            )
        }
