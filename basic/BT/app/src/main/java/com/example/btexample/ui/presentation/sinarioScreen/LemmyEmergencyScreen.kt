    ...
    Column(
        ...
        Column(
            ...
            ScenarioButton(
                index = 0,
                buttonText = "응급신고",
                onClick = { bluetoothViewModel.sendDataToDevice("<APCMEMERGENCYLEMMY>") }
            )
            ...
            ScenarioButton(
                index = 1,
                buttonText = "911호출",
                onClick = { bluetoothViewModel.sendDataToDevice("<APCMCALL911>") }
            )
            ...
            ScenarioButton(
                index = 2,
                buttonText = "응급문자 전송",
                onClick = { bluetoothViewModel.sendDataToDevice("<APCMSENDEMERGENCYMESSAGE>") }
            )
            ...
            ScenarioButton(
                ...
                buttonText = "복귀",
                onClick = {
                    bluetoothViewModel.sendDataToDevice("<APCMLEMMYBACK>")
                }
            )
        }
    }
