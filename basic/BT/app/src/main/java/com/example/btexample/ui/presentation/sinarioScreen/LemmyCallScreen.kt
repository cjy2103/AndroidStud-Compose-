...
fun LemmyCallScreen(
    ...
    fun ScenarioButton(
        ...
        Button(
            ...
            enabled = !buttonStates[index], // 클릭된 버튼은 비활성화
            modifier = Modifier
                .fillMaxWidth()
                .height(80.dp),
    ...
    Column(
        ...
        Column(
            ...
            ScenarioButton(
                index = 0,
                buttonText = "래미 호출",
                onClick = { bluetoothViewModel.sendDataToDevice("<APCMCALLLEMMY>") }
            )
            ...
            ScenarioButton(
                index = 1,
                buttonText = "날씨 알려줘",
                onClick = { bluetoothViewModel.sendDataToDevice("<APCMSHOWWEAHER>") }
            )
            ...
            ScenarioButton(
                ...
                buttonText = "일정 알려줘",
                onClick = {
                    bluetoothViewModel.sendDataToDevice("<APCMSHOWSCHEDULE>")
                }
            )
