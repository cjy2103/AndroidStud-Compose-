package com.example.moduledivide.ui.theme.screen
...
import com.example.data.CharacterProvider
...
@Composable
fun CharacterItem(character: CharacterData, onItemClick: (CharacterData) -> Unit){
    Row(
        modifier = Modifier
            .fillMaxWidth()
